...
#define DUPREQ_TCP_K_LATEST       20 /* Remember this number of TCP dupreq per connection */
#define DUPREQ_TCP_GC_PERIOD      100 /* How ofthen (number of rpc calls) should TCP DUPREQ be gc-ed ? */
