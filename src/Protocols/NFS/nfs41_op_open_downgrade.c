...
/**
 * \file    nfs41_op_open_downgrade.c
...
{
  char __attribute__ ((__unused__)) funcname[] = "nfs41_op_open_downgrade";
  ...
  return res_OPEN_DOWNGRADE4.status;
}                               /* nfs41_op_opendowngrade */

/**
 * nfs41_op_open_downgrade_Free: frees what was allocared to handle nfs4_op_open_downgrade.
 *
